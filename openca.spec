...
Projekt OpenCA PKI Development to wspólne próby stworzenia potężnego,
w pełni funkcjonalnego, działającego od razu po instalacji CA
(Certificate Authority) o otwartych źródłach z implementacją większości 
używanych protokołów oraz pełną silną kryptografią dostępną dla całego 
świata. OpenCA jest oparte na wielu projektach Open Source. Wśród 
wspieranego oprogramowania są OpenLDAP, OpenSSL, projekt Apache, 
mod_ssl dla Apache.
